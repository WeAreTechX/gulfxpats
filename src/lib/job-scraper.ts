...
export const GULF_COUNTRIES = {
  ...
  QATAR: { name: 'Qatar', code: 'QA', cities: ['Doha', 'Al Rayyan', 'Al Wakrah', 'Al Khor', 'Lusail'] },
...
export class JobScraper {
  ...
  // Main method to scrape jobs from all countries
  async scrapeAllJobs(): Promise<ScrapedJob[]> {
    ...
    try {
      ...
      console.log(`Successfully scraped ${this.jobs.length} jobs`);
      return this.jobs;
    } catch (error) {
